...
| 1× Step Down AC-DC Converter (220V to 5V) OR 1× Hi-Link HLK-PM01 AC-DC 220V to 5V Step-Down Power Supply | As power supply internally sourced (e.g. [ebay.de](http://r.ebay.com/rSZMfO)) |
